...
if NOT exist "%~1\" (
	...
	mklink /J "%~1\db\Retail\Categories.lua" "%cd%\db\Retail\.beta\Categories.lua"
	mklink /J "%~1\db\Retail\ExplorationDB.lua" "%cd%\db\Retail\ExplorationDB.lua"
	mklink /J "%~1\db\Retail\LocalizationDB.lua" "%cd%\db\Retail\.beta\LocalizationDB.lua"
	mklink /J "%~1\db\Retail\ReferenceDB.lua" "%cd%\db\Retail\.beta\ReferenceDB.lua"
...
if NOT exist "%~1\" (
	...
	mkdir "%~1\db\Retail"
	mklink "%~1\db\Presets.lua" "%cd%\db\Presets.lua"
	mklink /J "%~1\db\Retail\Categories.lua" "%cd%\db\Retail\.ptr\Categories.lua"
	mklink /J "%~1\db\Retail\ExplorationDB.lua" "%cd%\db\Retail\ExplorationDB.lua"
	mklink /J "%~1\db\Retail\LocalizationDB.lua" "%cd%\db\Retail\.ptr\LocalizationDB.lua"
	mklink /J "%~1\db\Retail\ReferenceDB.lua" "%cd%\db\Retail\.ptr\ReferenceDB.lua"
	mklink /J "%~1\assets" "%cd%\assets"
	mklink /J "%~1\lib" "%cd%\lib"
	mklink /J "%~1\locales" "%cd%\locales"
	mklink /J "%~1\src" "%cd%\src"
